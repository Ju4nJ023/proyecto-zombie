# ============================================================
# START_CORAL - Iniciar viaje a Isla Coral (Cutscene)
# Destino: 800 63 500
# ============================================================
...
execute as @e[type=minecraft:armor_stand,tag=motor_viaje,limit=1] run tag @s add destino_coral
...
title @s subtitle {"text":"Hacia Isla Coral...","color":"gray","italic":true}
title @s title {"text":"Zarpando","color":"aqua","bold":true}
