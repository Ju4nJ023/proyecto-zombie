...
execute at @s run tp @e[type=minecraft:villager,tag=viajando_guia,limit=1] 802.5 63.0 500.5

summon minecraft:boat 802.5 63.0 500.5 {Tags:["barca_viaje"],NoGravity:0b}

# Invocar motor invisible
summon minecraft:armor_stand 802.5 63.0 500.5 {Tags:["motor_viaje"],Invisible:1b,NoGravity:1b,Marker:1b,Rotation:[90f,0f]}
...
summon armor_stand 802.5 63.0 500.5 {Tags:["fake_player"],ShowArms:1b,NoGravity:1b,ArmorItems:[{id:"minecraft:leather_boots",Count:1b},{id:"minecraft:leather_leggings",Count:1b},{id:"minecraft:leather_chestplate",Count:1b},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:"mpilata"}}]}
