...
execute as @e[tag=viajando_guia] at @s rotated ~ 0 run tp @s ^ ^ ^0.2
...
# --- EL JUGADOR AHORA VIAJA MONTADO EN LA BARCA ---
# (Se eliminó el tp continuo para evitar temblores y que vaya bajo el agua)
