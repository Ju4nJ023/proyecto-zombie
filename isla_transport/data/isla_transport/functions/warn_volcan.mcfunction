...
data merge entity @e[type=minecraft:villager,tag=guia_isla,limit=1] {Offers:{Recipes:[{buy:{id:"minecraft:emerald",Count:1b,tag:{display:{Name:'{"text":"Token de Viaje","color":"gold","italic":false}'}}},sell:{id:"minecraft:green_wool",Count:1b,tag:{display:{Name:'{"text":"Sí, adelante","color":"green","bold":true,"italic":false}',Lore:['{"text":"Iniciar viaje a Isla Volcán","color":"gray","italic":false}','{"text":"a pesar del riesgo","color":"dark_gray","italic":false}']}}},maxUses:9999,rewardExp:0b,xp:0},{buy:{id:"minecraft:emerald",Count:1b,tag:{display:{Name:'{"text":"Token de Viaje","color":"gold","italic":false}'}}},sell:{id:"minecraft:red_wool",Count:1b,tag:{display:{Name:'{"text":"Me quedo porque le temo al éxito","color":"red","bold":true,"italic":false}',Lore:['{"text":"Cancelar viaje","color":"gray","italic":false}']}}},maxUses:9999,rewardExp:0b,xp:0}]}}

# Teletransportar aldeano de vuelta
execute as @e[type=minecraft:villager,tag=guia_isla] run tp @s 967 63 377
