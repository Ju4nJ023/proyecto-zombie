...
summon minecraft:villager 967 63 377 {Tags:["npc_guia","guia_isla"],NoAI:1b,NoGravity:1b,Invulnerable:1b,Silent:1b,CustomName:'{"text":"Guía de Islas","color":"aqua","bold":true}',VillagerData:{profession:"minecraft:cartographer",level:5,type:"minecraft:plains"},Offers:{Recipes:[{buy:{id:"minecraft:emerald",Count:64b},sell:{id:"minecraft:paper",Count:1b,tag:{display:{Name:'{"text":"Mapa de Islas","color":"gold","italic":false}'}}},maxUses:0,rewardExp:0b,xp:0}]}}
