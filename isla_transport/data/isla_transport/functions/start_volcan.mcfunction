...
execute as @s[tag=!mensaje_enviado] run tellraw @s [{"text":"[Transporte] ","color":"gold","bold":true},{"text":"¡Viaje a ","color":"yellow"},{"text":"Isla Volcán","color":"red","bold":true},{"text":" iniciado!","color":"yellow"}]
